...
- **Result:** PASS
- **Run (UTC):** 2026-09-24T15:53:08.241Z
- **GLLA revision:** `5c774574bc1b46335aefddfa1983c4010d0cc468` (package `0.38.98`)
...
- Temporary copy used for the run: `/tmp/glla-compaction-live-UTjsoa/historical-session.jsonl` (removed after verification).
...
- Summary length observed in memory: `32377` characters (content intentionally not recorded).
...
- Estimated preparation characters: `1238957` before → `58597` after (budget `64000`).
- Projection scale: `0.42250000000000004`; bounded messages: `62`; bounded fields: `71`; replaced images: `3`; bounded GLLA payloads: `0`; retained GLLA payloads: `0`.
