...
- **Result:** PASS
- **Run (UTC):** 2026-09-24T18:08:10.334Z
- **GLLA revision:** `d8d769b4bd0df316e8d7e92a30f263b07eb84ac9` (package `0.38.98`)
...
- Temporary copy used for the run: `/tmp/glla-compaction-live-tbQxhp/historical-session.jsonl` (removed after verification).
