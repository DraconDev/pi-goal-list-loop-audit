...
- **Result:** PASS
- **Run (UTC):** 2026-09-25T02:25:09.042Z
- **GLLA revision:** `9551c03d2c201f235020ad3f70f075af0b013d6e` (package `0.38.98`)
...
- Temporary copy: `/tmp/glla-compaction-live-jWfQZ7/historical-session.jsonl` (removed in the verifier's outer cleanup).
...
- Attempts: `1`; start reason: `threshold`; terminal aborted: `no`; terminal willRetry: `no`; in-memory summary characters: `15744`; persisted summary characters: `15744`.

- GLLA bounded preparation projection: **observed**.
- Estimated preparation characters: `41631` before → `13512` after (budget `16000`).
...
- Attempts: `1`; start reason: `manual`; terminal aborted: `no`; terminal willRetry: `no`; in-memory summary characters: `11961`; persisted summary characters: `11961`.
