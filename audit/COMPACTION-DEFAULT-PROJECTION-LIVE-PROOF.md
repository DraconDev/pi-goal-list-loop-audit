...
- **Result:** PASS
- **Run (UTC):** 2026-09-24T18:43:09.442Z
- **GLLA revision:** `8b4ae5fb86f648bb3823df4eb6c2857cc22c5604` (package `0.38.98`)
...
- Temporary copy used for the run: `/tmp/glla-compaction-live-oxiQ9E/historical-session.jsonl` (removed after verification).
...
- Summary length observed in memory: `16672` characters (content intentionally not recorded).
