...
- **Result:** PASS
- **Run (UTC):** 2026-09-24T18:50:52.716Z
- **GLLA revision:** `9a76a5491250016280db653eb2b45f138bad2c0c` (package `0.38.98`)
...
- Temporary copy used for the run: `/tmp/glla-compaction-live-cERSBO/historical-session.jsonl` (removed after verification).
...
- Summary length observed in memory: `17961` characters (content intentionally not recorded).
