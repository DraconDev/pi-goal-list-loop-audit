...
- **Result:** PASS
- **Run (UTC):** 2026-09-24T16:59:32.753Z
- **GLLA revision:** `2d64d23fe8a88ded26fbac3bbdcf1f042a10053c` (package `0.38.98`)
...
- Temporary copy used for the run: `/tmp/glla-compaction-live-B6BkEd/historical-session.jsonl` (removed after verification).
...
- Summary length observed in memory: `35518` characters (content intentionally not recorded).
...
- Estimated preparation characters: `158174` before → `58262` after (budget `64000`).
