...
test("fixture: repeated real continuation payloads grow context linearly and are isolated", () => {
  ...
  assert.equal(payload.length, 25_117);
  assert.equal(new TextEncoder().encode(payload).byteLength, 25_229);
  assert.deepEqual(one, {
    messageCount: 3,
    serializedBytes: 25_762,
    textChars: 25_169,
    estimatedTokens: 6_293,
    gllaMessageCount: 1,
    gllaSerializedBytes: 25_579,
    gllaTextChars: 25_117,
    gllaEstimatedTokens: 6_280,
  ...
  assert.deepEqual(twelve, {
    messageCount: 14,
    serializedBytes: 307_131,
    textChars: 301_456,
    estimatedTokens: 75_364,
    gllaMessageCount: 12,
    gllaSerializedBytes: 306_948,
    gllaTextChars: 301_404,
    gllaEstimatedTokens: 75_351,
    uniqueGllaPayloadCount: 1,
    repeatedGllaPayloadCount: 11,
    repeatedGllaSerializedBytes: 281_369,
    failedErrorOnlyCount: 0,
    unserializableMessageCount: 0,
    provider: {
      sampleCount: 12,
...
test("reported checkpoint shape stays pinned across all probe sizes", () => {
  ...
  assert.deepEqual(rows, [
    ...
    },
    {
      continuations: 5,
      messageCount: 7,
      serializedBytes: 128_078,
      textChars: 125_637,
      estimatedTokens: 31_410,
      gllaMessageCount: 5,
      gllaSerializedBytes: 127_895,
      gllaTextChars: 125_585,
      gllaEstimatedTokens: 31_397,
      repeatedGllaPayloadCount: 4,
      repeatedGllaSerializedBytes: 102_316,
      provider: {
        sampleCount: 5,
        inputTokens: 60_000,
        outputTokens: 510,
    ...
    },
    {
      continuations: 25,
      messageCount: 27,
      serializedBytes: 639_658,
      textChars: 627_977,
      estimatedTokens: 156_995,
      gllaMessageCount: 25,
      gllaSerializedBytes: 639_475,
      gllaTextChars: 627_925,
      gllaEstimatedTokens: 156_982,
      repeatedGllaPayloadCount: 24,
      repeatedGllaSerializedBytes: 613_896,
      provider: {
        sampleCount: 25,
        inputTokens: 800_000,
        outputTokens: 2_800,
