...
test("fixture: repeated real continuation payloads grow context linearly and are isolated", () => {
  ...
  assert.equal(payload.length, 24_651);
  assert.equal(new TextEncoder().encode(payload).byteLength, 24_767);
  assert.deepEqual(one, {
    messageCount: 3,
    serializedBytes: 25_300,
    textChars: 24_703,
    estimatedTokens: 6_176,
    gllaMessageCount: 1,
    gllaSerializedBytes: 25_117,
    gllaTextChars: 24_651,
    gllaEstimatedTokens: 6_163,
  ...
  assert.deepEqual(twelve, {
    messageCount: 14,
    serializedBytes: 301_587,
    textChars: 295_864,
    estimatedTokens: 73_966,
    gllaMessageCount: 12,
    gllaSerializedBytes: 301_404,
    gllaTextChars: 295_812,
    gllaEstimatedTokens: 73_953,
    uniqueGllaPayloadCount: 1,
    repeatedGllaPayloadCount: 11,
    repeatedGllaSerializedBytes: 276_287,
    failedErrorOnlyCount: 0,
    unserializableMessageCount: 0,
    provider: {
      sampleCount: 12,
...
test("reported checkpoint shape stays pinned across all probe sizes", () => {
  ...
  assert.deepEqual(rows, [
    ...
    },
    {
      continuations: 5,
      messageCount: 7,
      serializedBytes: 125_768,
      textChars: 123_307,
      estimatedTokens: 30_827,
      gllaMessageCount: 5,
      gllaSerializedBytes: 125_585,
      gllaTextChars: 123_255,
      gllaEstimatedTokens: 30_814,
      repeatedGllaPayloadCount: 4,
      repeatedGllaSerializedBytes: 100_468,
      provider: {
        sampleCount: 5,
        inputTokens: 60_000,
        outputTokens: 510,
    ...
    },
    {
      continuations: 25,
      messageCount: 27,
      serializedBytes: 628_108,
      textChars: 616_327,
      estimatedTokens: 154_082,
      gllaMessageCount: 25,
      gllaSerializedBytes: 627_925,
      gllaTextChars: 616_275,
      gllaEstimatedTokens: 154_069,
      repeatedGllaPayloadCount: 24,
      repeatedGllaSerializedBytes: 602_808,
      provider: {
        sampleCount: 25,
        inputTokens: 800_000,
        outputTokens: 2_800,
