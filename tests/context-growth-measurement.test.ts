...
test("fixture: repeated real continuation payloads grow context linearly and are isolated", () => {
  ...
  assert.equal(payload.length, 24_729);
  assert.equal(new TextEncoder().encode(payload).byteLength, 24_845);
  assert.deepEqual(one, {
    messageCount: 3,
    serializedBytes: 25_378,
    textChars: 24_781,
    estimatedTokens: 6_196,
    gllaMessageCount: 1,
    gllaSerializedBytes: 25_195,
    gllaTextChars: 24_729,
    gllaEstimatedTokens: 6_183,
  ...
  assert.deepEqual(twelve, {
    messageCount: 14,
    serializedBytes: 302_523,
    textChars: 296_800,
    estimatedTokens: 74_200,
    gllaMessageCount: 12,
    gllaSerializedBytes: 302_340,
    gllaTextChars: 296_748,
    gllaEstimatedTokens: 74_187,
    uniqueGllaPayloadCount: 1,
    repeatedGllaPayloadCount: 11,
    repeatedGllaSerializedBytes: 277_145,
    failedErrorOnlyCount: 0,
    unserializableMessageCount: 0,
    provider: {
      sampleCount: 12,
...
test("reported checkpoint shape stays pinned across all probe sizes", () => {
  ...
  assert.deepEqual(rows, [
    ...
    },
    {
      continuations: 5,
      messageCount: 7,
      serializedBytes: 126_158,
      textChars: 123_697,
      estimatedTokens: 30_925,
      gllaMessageCount: 5,
      gllaSerializedBytes: 125_975,
      gllaTextChars: 123_645,
      gllaEstimatedTokens: 30_912,
      repeatedGllaPayloadCount: 4,
      repeatedGllaSerializedBytes: 100_780,
      provider: {
        sampleCount: 5,
        inputTokens: 60_000,
        outputTokens: 510,
    ...
    },
    {
      continuations: 25,
      messageCount: 27,
      serializedBytes: 630_058,
      textChars: 618_277,
      estimatedTokens: 154_570,
      gllaMessageCount: 25,
      gllaSerializedBytes: 629_875,
      gllaTextChars: 618_225,
      gllaEstimatedTokens: 154_557,
      repeatedGllaPayloadCount: 24,
      repeatedGllaSerializedBytes: 604_680,
      provider: {
        sampleCount: 25,
        inputTokens: 800_000,
        outputTokens: 2_800,
