...
test("reported checkpoint shape stays pinned across all probe sizes", () => {
  ...
  assert.deepEqual(rows, [
    ...
    },
    {
      continuations: 5,
      messageCount: 7,
      serializedBytes: 129_758,
      textChars: 127_307,
      estimatedTokens: 31_827,
      gllaMessageCount: 5,
      gllaSerializedBytes: 129_575,
      gllaTextChars: 127_255,
      gllaEstimatedTokens: 31_814,
      repeatedGllaPayloadCount: 4,
      repeatedGllaSerializedBytes: 103_660,
      provider: {
        sampleCount: 5,
        inputTokens: 60_000,
        outputTokens: 510,
    ...
    },
    {
      continuations: 25,
      messageCount: 27,
      serializedBytes: 648_058,
      textChars: 636_327,
      estimatedTokens: 159_082,
      gllaMessageCount: 25,
      gllaSerializedBytes: 647_875,
      gllaTextChars: 636_275,
      gllaEstimatedTokens: 159_069,
      repeatedGllaPayloadCount: 24,
      repeatedGllaSerializedBytes: 621_960,
      provider: {
        sampleCount: 25,
        inputTokens: 800_000,
        outputTokens: 2_800,
